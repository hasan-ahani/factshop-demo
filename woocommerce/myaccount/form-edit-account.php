...
<div class="card  over-hidden p-4">
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label for="account_email"><?php esc_html_e( 'Email address', 'woocommerce' ); ?>&nbsp;<?php echo (cs_get_option('user_can_change_email')) ? null : '<span class="required">*</span>'; ?></label>
		<input type="email" class="form-control" name="account_email" id="account_email" autocomplete="email" value="<?php echo esc_attr( $user->user_email ); ?>"  <?php echo (cs_get_option('user_can_change_email')) ? 'disabled' : null; ?>/>
	</p>
