...
class Bako_Contact extends Widget_Base {
	
	public function get_name() {
		return 'factshop-contact';
	}
	
	public function get_title() {
		return __( 'اطلاعات تماس', 'factshop' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'text',
			[
				'label' => __( 'متن', 'factshop' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '00 00 138 021', '' ),
				'placeholder' => __( 'متن را وارد کنید', 'factshop' )
			]
		);
