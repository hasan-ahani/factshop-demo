...
class Icon extends Widget_Base {
	...
	public function get_name() {
		return 'factshop-icon';
	}
	
	public function get_title() {
		return __( 'آیکن', 'factshop' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'icon-circle',
				'options' => [
					'icon-circle'  => __( 'دایره', 'factshop' ),
					'icon-simple'  => __( 'معمولی', 'factshop' )
				],
			]
		);
	...
	protected function render() {
		...
		?>
		<i class="<?php echo esc_attr($settings['icon']) . ' ' . esc_attr($settings['style']); ?>"></i>
		<?php
	}
	
	protected function _content_template() {
		?>
		<i class="{{ settings.icon }} {{ settings.style }}"></i>
		<?php
	}
}
?>