...
;(function ( $, window, document, undefined ) {
  ...
  $.fn.CSFRAMEWORK_UPLOADER = function() {
    return this.each(function() {
      ...
      $add.on('click', function( e ) {
        ...
        if($add.data('pram-type')!= null){
            wp_media_frame.on( 'ready', function() {
                wp_media_frame.uploader.options.uploader.params = {
                    type: $add.data('pram-type')
                };
            });
        }
  ...
  $(document).ready( function() {
    ...
    $('.csf-field-code_editor').csf_field_code_editor();
